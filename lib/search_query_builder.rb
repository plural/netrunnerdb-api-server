...
class SearchQueryBuilder # rubocop:disable Metrics/ClassLength
  ...
  @@full_fields = [ # rubocop:disable Style/ClassVars
    ...
    FieldData.new(:boolean, both('charge'), ['charge'],
                  'Does the card have a charge ability?'),
    FieldData.new(:boolean, both('gains_subroutines'), ['gains_subroutines'],
                  'Does the card text allow for adding or gaining subroutines?'),
    FieldData.new(:boolean, both('gains_click'), ['gains_click'],
                  'Does the card have a gain click ability?'),
    ...
    FieldData.new(:boolean, both('install_effect'), ['install_effect'],
                  'Does the card have an install effect?'),
    ...
    FieldData.new(:boolean, both('is_unique'), %w[is_unique u],
                  'Is the card unique?'),
    FieldData.new(:boolean, both('mark'), ['mark'],
                  'Does the card refer to the mark?'),
    ...
    FieldData.new(:boolean, both('sabotage'), ['sabotage'],
                  'Does the card have a sabotage ability?'),
    FieldData.new(:boolean, both('score_effect'), ['score_effect'],
                  'Does the card have a score effect?'),
    FieldData.new(:boolean, both('steal_effect'), ['steal_effect'],
                  'Does the card have a steal effect?'),
